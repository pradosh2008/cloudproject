...
def get_aws_data(query, ini_file_path):
    ...
    chunk_list = []
    try:
        conn = connect(aws_access_key_id=parser['AWS-DEV']['aws_access_key_id'],   # 'YOUR_ACCESS_KEY_ID'
                       aws_secret_access_key=parser['AWS-DEV']['aws_secret_access_key'],  # 'YOUR_SECRET_ACCESS_KEY'
                       aws_session_token=parser['AWS-DEV']['aws_session_token'],  # YOUR_SESSION_TOKEN
