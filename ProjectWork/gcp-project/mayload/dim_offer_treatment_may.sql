...
CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.DIM_OFFER_TREATMENT_MAY (
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.dim_offer_treatment_may
...
FROM ascena_staging_dev.jus_hst_treatments_dr as t where t.batch_id='20190501';
