...
drop table ascena_analytic_mart_dev.DIM_PROMO_EXECUTION_HIERARCHY ;

CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.DIM_PROMO_EXECUTION_HIERARCHY (
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.DIM_PROMO_EXECUTION_HIERARCHY
...
FROM ascena_staging_dev.jus_hst_promotion_segments_drc as s
LEFT OUTER JOIN ascena_staging_dev.jus_hst_promotion_cells_drc as c
