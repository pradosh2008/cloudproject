...
drop table ascena_outbound_dev.DIM_STORE ;
--Create table statement
create TABLE IF NOT EXISTS ascena_outbound_dev.DIM_STORE (
     store_key           CHAR(32)
    ,brand_cd               string
    ,store_num           BIGINT
...
--insert statement
INSERT OVERWRITE TABLE ascena_outbound_dev.DIM_STORE
select md5(concat('JUS|',e.store_id)) as store_key
,'JUS' as brand_cd
...
from ascena_staging_dev.jus_hst_stores_20190105 as e;
--Primary Key check
