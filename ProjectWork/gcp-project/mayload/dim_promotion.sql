...
drop TABLE ascena_analytic_mart_dev.DIM_PROMOTION;

CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.DIM_PROMOTION(
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.DIM_PROMOTION
select 
...
ascena_staging_dev.jus_hst_promotions_drc as a ;
