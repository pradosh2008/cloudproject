...
CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.dim_package_treatment_may (
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.dim_package_treatment_may
...
FROM ascena_staging_dev.jus_hst_package_treatments_dr as t
LEFT OUTER JOIN ascena_staging_dev.jus_hst_packages_dr as p
ON p.package_id = t.package_id
where p.batch_id='20190501' and t.batch_id='20190501';
