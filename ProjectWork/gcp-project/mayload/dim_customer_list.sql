...
drop TABLE ascena_analytic_mart_dev.dim_customer_list;

CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.dim_customer_list (
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.dim_customer_list
SELECT 
