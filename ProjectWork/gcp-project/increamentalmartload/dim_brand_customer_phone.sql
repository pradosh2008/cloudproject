...
create TABLE IF NOT EXISTS ascena_analytic_mart_dev.DIM_BRAND_CUSTOMER_PHONE
(
...
--insert statement
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.DIM_BRAND_CUSTOMER_PHONE
...
from ASCENA_STAGING_DEV.jus_hst_customer_phones_drc as e
;
