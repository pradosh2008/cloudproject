...
drop TABLE ascena_analytic_mart_dev.dim_offer;

CREATE TABLE IF NOT EXISTS ascena_analytic_mart_dev.dim_offer
(
     OFFER_KEY CHAR(32)
...
INSERT OVERWRITE TABLE ascena_analytic_mart_dev.dim_offer
SELECT 
...
FROM ascena_staging_dev.jus_hst_offer_codes_drc as jho
UNION
SELECT 
...
LEFT OUTER JOIN ascena_staging_dev.jus_hst_offer_codes_drc as JHO
