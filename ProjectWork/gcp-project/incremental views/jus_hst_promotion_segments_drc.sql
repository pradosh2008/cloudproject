CREATE OR REPLACE VIEW ASCENA_STAGING_DEV.JUS_HST_PROMOTION_SEGMENTS_DRC
AS 
WITH MID AS
(SELECT 
TBL.PROMOTION_ID
...
FROM ASCENA_STAGING_DEV.JUS_HST_PROMOTION_SEGMENTS_20190105 TBL)
SELECT TBL1.* 
FROM ASCENA_STAGING_DEV.JUS_HST_PROMOTION_SEGMENTS_20190105 TBL1
JOIN MID
ON TBL1.BATCH_ID = MID.MAX_BATCH_ID	
AND TBL1.PROMOTION_ID = MID.PROMOTION_ID
AND TBL1.SEGMENT_ID = MID.SEGMENT_ID
