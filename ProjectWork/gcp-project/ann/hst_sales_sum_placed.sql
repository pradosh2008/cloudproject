create or replace table work.hist_sales_sum_placed as 
select  
 Store_ID
 ,Week_ID
 ,Style_ID
...
left join edl_landing.lu_product_vw pr
  on pr.product_id = t.product_id 
   /* where 
  store_nbr in  (2905,2915,2997,3019,2942,2967) and fiscal_week_id = 201707  and s.style_nbr = 407817  and Color_cd = 6600 */
--  2905	201707	407817	6600
    )
